            ...
            <form id="agregar_maqn">
                ...
                <div class="input">
                    ...
                    <div>
                        ...
                        <input type="radio" name="personal" value="interno" <?php if ($id != null) echo 'disabled '; if ($personal == 'interno') echo 'checked'; ?>>
                    </div>
                    <div>
                        <label for="personal">Externo</label>
                        <input type="radio" name="personal" value="externo" <?php if ($id != null) echo 'disabled ';if ($personal == 'externo') echo 'checked'; ?>>
                    </div>
                </div>
                <div class="input input_rt">
                    <div>
                        <label for="tipo">Tipo:</label>
                    </div>
                    <div>
                        <label for="tipo">Correctivo</label>
                        <input type="radio" name="tipo" value="correctivo" <?php if ($id != null) echo 'disabled '; if ($tipo == 'correctivo') echo 'checked'; ?>>
                    </div>
                    <div>
                        <label for="tipo">Preventivo</label>
                        <input type="radio" name="tipo" value="preventivo" <?php if ($id != null) echo 'disabled ';if ($tipo == 'preventivo') echo 'checked'; ?>>
                    </div>
                </div>
                <div class="input">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="radio" name="periodicidad" value="mensual" <?php if ($id != null) echo 'disabled '; if ($periodicidad == 'mensual') echo 'checked'; ?>>
                    </div>
                    <div>
                        <label for="periodicidad">Trimestral</label>
                        <input type="radio" name="periodicidad" value="trimestral" <?php if ($id != null) echo 'disabled ';if ($periodicidad == 'trimestral') echo 'checked'; ?>>
                    </div>
                    <div>
                        <label for="periodicidad">Semestral</label>
                        <input type="radio" name="periodicidad" value="semestral" <?php if ($id != null) echo 'disabled ';if ($periodicidad == 'semestral') echo 'checked'; ?>>
                    </div>
                    <div>
                        <label for="periodicidad">Anual</label>
                        <input type="radio" name="periodicidad" value="anual" <?php if ($id != null) echo 'disabled ';if ($periodicidad == 'anual') echo 'checked'; ?>>
                    </div>
                </div>
                <div class="input">
